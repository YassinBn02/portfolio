...
export default function SallaSallaGallery() {
    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {sallaSallaImages.map((image, index) => (
                    <div
                        key={image}

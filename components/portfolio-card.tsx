    ...
    >
      <div className="relative w-full pt-[125%]" suppressHydrationWarning>
        <Image
          ...
          alt={item.title}
          fill
          className={`absolute inset-0 w-full h-full ${item.title === "Le bout de la mer" || item.title === "Lucidream" || item.title === "Spot Coca Cola Marroc" ? "object-contain bg-black" : "object-cover"} transition-transform duration-300 group-hover:scale-110`}
        />
      </div>

    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">Spot Al Mazraa Gallery</DialogTitle>
                <div className="relative w-full h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <Image
                            ...
                            alt={`Spot Al Mazraa ${currentIndex + 1}`}
                            fill
...
export default function SpotAlMazraaGallery() {
    const [isOpen, setIsOpen] = useState(false);
    const [selectedIndex, setSelectedIndex] = useState(0);

    // Project Information
    const projectInfo = {
        title: "SPOT AL MAZRAA",
        year: "2023",
        director: "Mourad Kalai",
        producer: "Linea Prod",
        role: "Costume Designer",
        videoUrl: "/mazraa/elmazraa_tvc_v1 (1080p).mp4",
    };

    const images = [
        "Captura de pantalla 2026-02-12 121835.png",
        "Captura de pantalla 2026-02-12 121933.png",
        "Captura de pantalla 2026-02-12 122022.png",
        "Captura de pantalla 2026-02-12 122152.png"
    ];
            ...
            <div className="flex flex-col items-center mb-16 space-y-6">
                ...
                <div className="w-full max-w-4xl mx-auto aspect-video rounded-xl overflow-hidden bg-black shadow-2xl">
                    <video
                        ...
                        poster={getImageUrl("Captura de pantalla 2026-02-12 121835.png")}
                    />
                </div>

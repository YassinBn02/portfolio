    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">Spot Selja Gallery</DialogTitle>
...
export default function SpotSeljaGallery() {
    ...
    const projectInfo = {
        ...
        trailerUrl: "https://vimeo.com/847319996",
    };

    const images = [
        "Captura de pantalla 2026-02-12 112849.png",
        "Captura de pantalla 2026-02-12 113225.png",
        "Selja TVC 2023.png"
    ];

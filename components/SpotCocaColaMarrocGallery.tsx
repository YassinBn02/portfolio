    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">Spot Coca Cola Marroc Gallery</DialogTitle>
                <div className="relative w-full h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <Image
                            ...
                            alt={`Spot Coca Cola Marroc ${currentIndex + 1}`}
                            fill
...
export default function SpotCocaColaMarrocGallery() {
    ...
    const images = [
        "Captura de pantalla 2026-02-11 140526.png",
        "Captura de pantalla 2026-02-11 140702.png",
        "Captura de pantalla 2026-02-11 140729.png",
        "Captura de pantalla 2026-02-11 140831.png",
        "Captura de pantalla 2026-02-11 140944.png"
    ];
                ...
                {images.map((image, index) => (
                    ...
                    >
                        <Image
                            ...
                            alt={`Spot Coca Cola Marroc ${index + 1}`}
                            fill

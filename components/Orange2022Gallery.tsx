    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">Orange 2022 Gallery</DialogTitle>
                <div className="relative w-full h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <Image
                            ...
                            alt={`Orange 2022 ${currentIndex + 1}`}
                            fill
...
export default function Orange2022Gallery() {
    ...
    const projectInfo = {
        ...
        videoUrl: "/orange 2022/orange_world_cup_tvc_v1 (1080p).mp4",
    };

    const images = [
        "Captura de pantalla 2026-02-12 120412.png",
        "Captura de pantalla 2026-02-12 120459.png",
        "Captura de pantalla 2026-02-12 120559.png",
        "Captura de pantalla 2026-02-12 120650.png",
        "Captura de pantalla 2026-02-12 120835.png",
        "Captura de pantalla 2026-02-12 121133.png",
        "Captura de pantalla 2026-02-12 121256.png",
        "Captura de pantalla 2026-02-12 121511.png"
    ];
            ...
            <div className="flex flex-col items-center mb-16 space-y-6">
                ...
                <div className="w-full max-w-4xl mx-auto aspect-video rounded-xl overflow-hidden bg-black shadow-2xl">
                    <video
                        ...
                        poster={getImageUrl("Captura de pantalla 2026-02-12 120559.png")}
                    />
                </div>

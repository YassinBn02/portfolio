    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">La Maison Dorée Gallery</DialogTitle>
                <div className="relative w-full h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <Image
                            ...
                            alt={`La Maison Dorée ${currentIndex + 1}`}
                            fill
...
export default function LaMaisonDoreeGallery() {
    ...
    const projectInfo = {
        ...
        producedBy: "Linea Studio",
        role: "Costume Designer",
        trailerUrl: "https://www.youtube.com/embed/87n5cr9zzEA",
    };
    ...
    if (laMaisonDoreeImages.length === 0) {
        return (
    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {laMaisonDoreeImages.map((image, index) => (
                    <div
                        key={image}

    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">Golden Coffee 2023 Gallery</DialogTitle>
                <div className="relative w-full h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <Image
                            ...
                            alt={`Golden Coffee 2023 ${currentIndex + 1}`}
                            fill
...
export default function GoldenCoffee2023Gallery() {
    const [isOpen, setIsOpen] = useState(false);
    const [selectedIndex, setSelectedIndex] = useState(0);

    // Project Information
    const projectInfo = {
        title: "GOLDEN COFFEE 2023",
        year: "2023",
        producer: "Linea Prod",
        role: "Wardrobe Assistant",
        videoUrl: "/golde caffe 2023/golden_coffee_tvc_v1 (1080p).mp4",
    };

    const images = [
        "Captura de pantalla 2026-02-12 115304.png",
        "Captura de pantalla 2026-02-12 115355.png",
        "Captura de pantalla 2026-02-12 115430.png",
        "Captura de pantalla 2026-02-12 115523.png",
        "Captura de pantalla 2026-02-12 115607.png",
        "Captura de pantalla 2026-02-12 115709.png"
    ];
            ...
            <div className="flex flex-col items-center mb-16 space-y-6">
                ...
                <div className="w-full max-w-4xl mx-auto aspect-video rounded-xl overflow-hidden bg-black shadow-2xl">
                    <video
                        ...
                        poster={getImageUrl("Captura de pantalla 2026-02-12 115304.png")}
                    />
                </div>
                ...
                {images.map((image, index) => (
                    ...
                    >
                        <Image
                            ...
                            alt={`Golden Coffee 2023 ${index + 1}`}
                            fill

...
const getImageUrl = (image: string) => {
    return `/golden Coffee Tvc 1/${image}`;
};
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-screen max-h-screen w-screen h-screen m-0 rounded-none p-0 bg-black border-none sm:max-w-none sm:h-screen gap-0 p-0">
                <DialogTitle className="sr-only">Golden Coffee TVC1 Gallery</DialogTitle>
                <div className="relative w-full h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <Image
                            ...
                            alt={`Golden Coffee TVC1 ${currentIndex + 1}`}
                            fill
...
export default function GoldenCoffeeTVC1Gallery() {
    const [isOpen, setIsOpen] = useState(false);
    const [selectedIndex, setSelectedIndex] = useState(0);

    // Project Information
    const projectInfo = {
        title: "GOLDEN COFFEE TVC1",
        year: "2023",
        producer: "Linea Prod",
        role: "Wardrobe Assistant",
        videoUrl: "/golden Coffee Tvc 1/Golden Coffee TVC 1.mp4",
    };

    const images = [
        "Captura de pantalla 2026-02-12 113511.png",
        "Captura de pantalla 2026-02-12 113626.png",
        "Captura de pantalla 2026-02-12 113707.png",
        "Captura de pantalla 2026-02-12 113804.png",
        "Captura de pantalla 2026-02-12 113839.png",
        "Captura de pantalla 2026-02-12 113936.png",
        "Captura de pantalla 2026-02-12 114112.png",
        "Golden Coffee TVC emna 1.png"
    ];
            ...
            <div className="flex flex-col items-center mb-16 space-y-6">
                ...
                <div className="w-full max-w-4xl mx-auto aspect-video rounded-xl overflow-hidden bg-black shadow-2xl">
                    <video
                        ...
                        poster={getImageUrl("Captura de pantalla 2026-02-12 113936.png")}
                    />
                </div>
                ...
                {images.map((image, index) => (
                    ...
                    >
                        <Image
                            ...
                            alt={`Golden Coffee TVC1 ${index + 1}`}
                            fill
